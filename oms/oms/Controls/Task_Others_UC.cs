...
{
    public partial class Task_Others_UC : UserControl, IOrderTaskUserControl
    {
        ...
        private void LoadGrid()
        {
            ...
            //this.gridView.Columns["Step"].OptionsColumn.AllowEdit = false;
            ...
            this.gridView.ShowingEditor += (sender, e) =>
            {
        ...
        private void LoadData()
        {
            ...
            if (this.currentWorkingOrderTask != null)
            {
                ...
                if (notesElement != null)
                {
                    ...
                    {
                        bool isdefault = CommonFunctions.GetBoolSafely(item.GetAttribute("default"));
